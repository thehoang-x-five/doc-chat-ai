"""
Processing callbacks and event system for RAG Pipeline.
...
Adapted from upstream RAGAnything v1.2.10 callbacks module.

Usage::

    from app.services.rag_patterns.pipeline.callbacks import (
        ProcessingCallback, MetricsCallback, CallbackManager,
    )
    ...
    pipeline.callback_manager.register(MyCallback())
"""
...
class MetricsCallback(ProcessingCallback):
    ...
    Example::
        ...
        pipeline.callback_manager.register(metrics_cb)
        # ... process documents ...
    ...
    def summary(self) -> str:
        ...
        m = self.metrics
        lines = [
            "RAG Pipeline Processing Metrics",
            "=" * 40,
...
class CallbackManager:
    ...
    def register(self, callback: ProcessingCallback) -> None:
        ...
        Args:
            callback: An instance of ProcessingCallback (or subclass).

        Raises:
            TypeError: If callback is not a ProcessingCallback.
        """
    ...
    def enable_event_log(self, enabled: bool = True) -> None:
        ...
        event_log for later inspection.
        """
        with self._lock:
